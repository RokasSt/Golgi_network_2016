...
def density_model(location_parameters,cellType,seed_number,popIndex=None,cell_position_array=None,cell_array=None,cell_diameter_array=None):
    ...
    if dim_X_array==dim_Y_array:
       ...
       if left_x_found and right_x_found and low_y_found and high_y_found:
          ...
          total_no_of_cells=0       
          density_value_array=[]
          density_value_array_per_point=[]
          density_value_array_per_point_before_rounding=[]
          for Y_index in range(0,len(Y_index_array)):
              for X_index in range(0,len(X_index_array)):
                  ...
                  density_value_array.append(density_value)
                  density_value_array_per_point_before_rounding.append(density_value*canonical_volume)
                  no_of_cells_per_density_point=int(round(density_value*canonical_volume))
                  density_value_array_per_point.append(no_of_cells_per_density_point)
          ...
          for Y_index in range(0,len(Y_index_array)):
              for X_index in range(0,len(X_index_array)):
                  ...
                  if location_parameters['distanceModel']=="random_minimal_distance":
                     ...
                     im_dict_max_values={}
                     dim_dict_max_values['x_dim']=sqrt(base_area_microns)
                     dim_dict_max_values['y_dim']=sqrt(base_area_microns)
                     ...
                     seed_numbergolgi_pop_object,dim_dict_max_values,dim_dict_offsets,total_no_of_cells,dim_dict_mappings,cell_counter)
