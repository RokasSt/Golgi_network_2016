...
if __name__ == "__main__":
    ...
    net_params_test_2012_multiple['experiment1']['experimentID']="V2012_test1_import_colocalize_plus_regional"
 ...
 'maxNoGJs':10,'averageNoGJs':8, 'spatialScale':1,'testingConductanceScale':1,'targetingModelprePop':{'model':"segment groups and segments",'segmentGroupList':["Section_1","dend_1"], 'segmentGroupProbabilities':{"Section_1":0.7,"dend_1":0.3}},'targetingModelpostPop':{'model':"segment groups and segments",\
    ...
    inputGroups_pop0_exp1.append({'inputModel':'XF', 'targetingRegime':"3D_region_specific",'regionList':[ {'xVector':[0,40],'yVector':[0,40],'zVector':[0,40]}],'inputLabel':'MF_AMPA_NMDA','fractionToTarget':1,'synapseList':synapseList_pop0_exp1,'colocalizeSynapses':True,'inputIdLibrary':"XFpop0_Golgi_pop0_syn0",'synapseMode':"transient",'averageRate':150,'delay':80,'duration':100,'units':'ms','numberModel':"constant number of inputs per cell",'noInputs':8,'targetingModel':"segments and subsegments",'segmentList':["Soma","dend_1"],'segmentProbabilities':{"Soma":0.7,"dend_1":0.3},'fractionAlongANDsubsegProbabilities':{"Soma":[{"fractionAlong":0.25,"Prob":1},{"fractionAlong":0.25,"Prob":0}],"dend_1":[{"fractionAlong":0.5,"Prob":0.7},{"fractionAlong":0.5,"Prob":0.3}] } } )
    ...
    'saveSomataPositions':True,'parentDirRequired':True,'parentDir':parentdir,'currentDirRequired':True,'currentDir':currentdir,'networkDir':'example',\
        'saveInputReceivingCellID':True,'importPoissonTrainLibraries':True,'PoissonTrainLibraryID':'V2012_test1_import',\
