...
if __name__ == "__main__":
    ...
    net_params_test_2010_multiple['experiment1']['experimentID']="test_density_4"
    
    #exp1
    net_params_test_2010_multiple['experiment1']['popParams']=[]
    net_params_test_2010_multiple['experiment1']['popParams'].append({'popID':'Golgi_pop0','cellType':"Golgi_10comp_13channels_2CaPools",'size':0,"NeuroML2CellType":"cell2CaPools"})
    ...
    'planeDimensions':{'dim1':'x','dim2':'y'},'dim1CoordinateVector':[1900,2000],'dim2CoordinateVector':[0,100],'dim3':'z','dim3Boundary':,\
