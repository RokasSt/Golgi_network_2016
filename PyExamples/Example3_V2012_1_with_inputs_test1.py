...
if __name__ == "__main__":
    ...
    net_params_test_2012_multiple['experiment1']['distributionParams']['populationList'].append({'popID':'Golgi_pop0','distributionModel':'explicit_cell_numbers','distanceModel':'random_no_overlap','xDim':100,'yDim':100,'zDim':100})
    net_params_test_2012_multiple['experiment1']['distributionParams']['populationList'].append({'popID':'Golgi_pop1','distributionModel':'explicit_cell_numbers','distanceModel':'random_no_overlap','xDim':100,'yDim':100,'zDim':100})
...
####### change 'simulator' to "jNeuroML_NEURON" in order to run simulations in NEURON
    ...
    net_params_test_2012_multiple['experiment2']['distributionParams']['populationList'].append({'popID':'Golgi_pop0','distributionModel':'explicit_cell_numbers','distanceModel':'random_no_overlap','xDim':100,'yDim':100,'zDim':100})
    net_params_test_2012_multiple['experiment2']['distributionParams']['populationList'].append({'popID':'Golgi_pop1','distributionModel':'explicit_cell_numbers','distanceModel':'random_no_overlap','xDim':100,'yDim':100,'zDim':100})
