...
if __name__ == "__main__":
    ...
    net_params_test_2012_multiple['experiment1']['experimentID']="V2012_test_import_plus_regional_cell_selection"
    ...
    net_params_test_2012_multiple['experiment1']['popParams'].append({'popID':'Golgi_pop0','cellType':"Golgi_10comp_13channels_2CaPools",'size':16,"NeuroML2CellType":"cell2CaPools"})
    ...
    net_params_test_2012_multiple['experiment1']['connParams']['populationPairs'].append({'electricalConnModel':"Vervaeke_2012_based",'prePopID':'Golgi_pop0',\
                                                    ...
                                                    'averageConductance':426,'stdDev':20,'units':"pS",'maximalConnDistance':200,\
    ...
    inputGroups_pop0_exp1.append({'inputModel':'XF','inputLabel':'XFpop0','targetingRegime':"3D_region_specific",'regionList':[ {'xVector':[0,50],'yVector':[0,50],'zVector':[0,50]} ],'fractionToTarget':1,'synapseList':synapseList_pop0_exp1,'colocalizeSynapses':False})
