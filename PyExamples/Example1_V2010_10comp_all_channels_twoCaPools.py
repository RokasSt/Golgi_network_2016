...
if __name__ == "__main__":
    ...
    net_params_test_2010_multiple['experiment1']['experimentID']="test_10comp_all_channels_twoCaPools"
    
    
    net_params_test_2010_multiple['experiment1']['popParams']=[]
    net_params_test_2010_multiple['experiment1']['popParams'].append({'popID':'Golgi_pop0','cellType':"Golgi_10comp_all_channels_twoCaPools",'size':2, "NeuroML2CellType":"cell2CaPools"})
