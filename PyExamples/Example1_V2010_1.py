...
if __name__ == "__main__":
    ...
    net_params_test_2010_multiple['experiment1']['experimentID']="test_V2010_exp1_random_with_overlap"
    ...
    net_params_test_2010_multiple['experiment1']['popParams'].append({'popID':'Golgi_pop0','cellType':"Golgi_5comp_3channels_1CaPool",'size':180})
    ...
    net_params_test_2010_multiple['experiment1']['distributionParams']['populationList'].append({'popID':'Golgi_pop0','distributionModel':'explicit_cell_numbers','distanceModel':'random','xDim':700,'yDim':700,'zDim':80})
