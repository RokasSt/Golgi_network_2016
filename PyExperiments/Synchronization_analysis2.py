...
#Synchronization_analysis(sim_duration,specify_targets,no_of_groups,exp_specify,spike_plot_parameters,general_plot_parameters):
   ...
   #plot_params=["V2010_test_sync_dt","Golgi cell population","Number of cells",["45"],3,3] 


   #Synchronization_analysis(3000,["3D region specific",[[0,3000],[0,110],[0,50]],"subtype specific","random fraction",[1.0] ],\
#1,[["V2010_test_improved_dt"],["seed specifier",False],1],spike_plot_params,plot_params)
   ...
   #Synchronization_analysis(3000,["3D region specific",[[0,3000],[0,110],[0,100]],"subtype specific","random fraction",[1.0] ],\
#1,[["V2010_regional_from_left_to_right_200ms"],["seed specifier",False],1],spike_plot_params,plot_params)
   ...
   plot_params=["V2010_reg_l_to_r_200ms_86c","Golgi cell population","Number of cells",["95","164","240"],3,3] 


   Synchronization_analysis(3000,["3D region specific",[[0,3000],[0,110],[0,360]],"subtype specific","random fraction",[1.0] ],\
1,[["V2010_regional_from_left_to_right_200ms_150","V2010_regional_from_left_to_right_200ms_250","V2010_regional_from_left_to_right_200ms_350"],["seed specifier",False],1],spike_plot_params,plot_params)
