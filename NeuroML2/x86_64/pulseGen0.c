...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 2);
 	...
 	ivoc_help("help ?1 pulseGen0 /home/rokas/Golgi_network_2016/NeuroML2/x86_64/pulseGen0.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=pulseGen0 type=pulseGenerator)";
