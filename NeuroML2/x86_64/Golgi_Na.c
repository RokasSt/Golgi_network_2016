...
extern Memb_func* memb_func;
 ...
 "gmax_Golgi_Na", "S/cm2",
 "conductance_Golgi_Na", "uS",
 "m_reverseRate_rate_Golgi_Na", "kHz",
 "m_reverseRate_midpoint_Golgi_Na", "mV",
 "m_reverseRate_scale_Golgi_Na", "mV",
 "m_forwardRate_rate_Golgi_Na", "kHz",
 "m_forwardRate_midpoint_Golgi_Na", "mV",
 "m_forwardRate_scale_Golgi_Na", "mV",
 "m_q10Settings_experimentalTemp_Golgi_Na", "K",
 "m_q10Settings_TENDEGREES_Golgi_Na", "K",
 "h_reverseRate_TIME_SCALE_Golgi_Na", "ms",
 "h_reverseRate_VOLT_SCALE_Golgi_Na", "mV",
 "h_forwardRate_rate_Golgi_Na", "kHz",
 "h_forwardRate_midpoint_Golgi_Na", "mV",
 "h_forwardRate_scale_Golgi_Na", "mV",
 "h_q10Settings_experimentalTemp_Golgi_Na", "K",
 "h_q10Settings_TENDEGREES_Golgi_Na", "K",
 "gion_Golgi_Na", "S/cm2",
 "m_reverseRate_r_Golgi_Na", "kHz",
 "m_forwardRate_r_Golgi_Na", "kHz",
 "m_alpha_Golgi_Na", "kHz",
 "m_beta_Golgi_Na", "kHz",
 "m_tau_Golgi_Na", "ms",
 "h_reverseRate_r_Golgi_Na", "kHz",
 "h_forwardRate_r_Golgi_Na", "kHz",
 "h_alpha_Golgi_Na", "kHz",
 "h_beta_Golgi_Na", "kHz",
 "h_tau_Golgi_Na", "ms",
 "g_Golgi_Na", "uS",
 0,0
...
"Golgi_Na",
 "gmax_Golgi_Na",
 "conductance_Golgi_Na",
 "m_instances_Golgi_Na",
 "m_reverseRate_rate_Golgi_Na",
 "m_reverseRate_midpoint_Golgi_Na",
 "m_reverseRate_scale_Golgi_Na",
 "m_forwardRate_rate_Golgi_Na",
 "m_forwardRate_midpoint_Golgi_Na",
 "m_forwardRate_scale_Golgi_Na",
 "m_q10Settings_q10Factor_Golgi_Na",
 "m_q10Settings_experimentalTemp_Golgi_Na",
 "m_q10Settings_TENDEGREES_Golgi_Na",
 "h_instances_Golgi_Na",
 "h_reverseRate_TIME_SCALE_Golgi_Na",
 "h_reverseRate_VOLT_SCALE_Golgi_Na",
 "h_forwardRate_rate_Golgi_Na",
 "h_forwardRate_midpoint_Golgi_Na",
 "h_forwardRate_scale_Golgi_Na",
 "h_q10Settings_q10Factor_Golgi_Na",
 "h_q10Settings_experimentalTemp_Golgi_Na",
 "h_q10Settings_TENDEGREES_Golgi_Na",
 0,
 "gion_Golgi_Na",
 "m_reverseRate_r_Golgi_Na",
 "m_forwardRate_x_Golgi_Na",
 "m_forwardRate_r_Golgi_Na",
 "m_q10Settings_q10_Golgi_Na",
 "m_rateScale_Golgi_Na",
 "m_alpha_Golgi_Na",
 "m_beta_Golgi_Na",
 "m_fcond_Golgi_Na",
 "m_inf_Golgi_Na",
 "m_tau_Golgi_Na",
 "h_reverseRate_V_Golgi_Na",
 "h_reverseRate_r_Golgi_Na",
 "h_forwardRate_r_Golgi_Na",
 "h_q10Settings_q10_Golgi_Na",
 "h_rateScale_Golgi_Na",
 "h_alpha_Golgi_Na",
 "h_beta_Golgi_Na",
 "h_fcond_Golgi_Na",
 "h_inf_Golgi_Na",
 "h_tau_Golgi_Na",
 "conductanceScale_Golgi_Na",
 "fopenHHrates_Golgi_Na",
 "fopenHHtauInf_Golgi_Na",
 "fopenHHratesTau_Golgi_Na",
 "fopenHHratesInf_Golgi_Na",
 "fopenHHratesTauInf_Golgi_Na",
 "fopenHHInstantaneous_Golgi_Na",
 "fopen_Golgi_Na",
 "g_Golgi_Na",
 0,
 "m_q_Golgi_Na",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 62, 3);
 	...
 	ivoc_help("help ?1 Golgi_Na /home/rokas/Golgi_network_2016/NeuroML2/x86_64/Golgi_Na.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=Golgi_Na type=ionChannelHH)";
