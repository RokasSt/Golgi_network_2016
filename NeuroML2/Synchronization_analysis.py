...
if __name__=="__main__":
   ...
   Synchronization_analysis(450,["subtype specific","random fraction","randomly set target ids only once",[1,1]],2,[["V2010multi1_2c_1input"],["seed specifier",True],1],spike_plot_params,plot_params)
