...
Components:
    ...
    V2010_2cells_1input_network (Type: networkWithTemperature:  temperature=296.15 (SI temperature))
    null (Type: include)
    null (Type: include)
    null (Type: include)
    ...
    V2010_2cells_1input (Type: Simulation:  length=0.45 (SI time) step=5.0E-6 (SI time))
...
# Adding simulation Component(id=V2010_2cells_1input type=Simulation) of network/component: V2010_2cells_1input_network (Type: networkWithTemperature:  temperature=296.15 (SI temperature))
...
f_Volts0_file0_0_f2 = open('simulations/sim0/Golgi_pop0_NEURON_V2010multi1_cell0.dat', 'w')
for i in range(int(h.tstop * h.steps_per_ms) + 1):
    f_Volts0_file0_0_f2.write('%e\t'% py_v_time[i]  + '%e\t'%(py_v_v0_Volts0_file0_0[i]) + '\n')
f_Volts0_file0_0_f2.close()
print("Saved data to: simulations/sim0/Golgi_pop0_NEURON_V2010multi1_cell0.dat")
...
f_Volts0_file0_1_f2 = open('simulations/sim0/Golgi_pop0_NEURON_V2010multi1_cell1.dat', 'w')
for i in range(int(h.tstop * h.steps_per_ms) + 1):
    f_Volts0_file0_1_f2.write('%e\t'% py_v_time[i]  + '%e\t'%(py_v_v1_Volts0_file0_1[i]) + '\n')
f_Volts0_file0_1_f2.close()
print("Saved data to: simulations/sim0/Golgi_pop0_NEURON_V2010multi1_cell1.dat")
